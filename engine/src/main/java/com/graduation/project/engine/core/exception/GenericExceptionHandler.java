...
public class GenericExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleAException(EntityNotFoundException e) {
    ...
    GenericExceptionSignature notFoundException = new GenericExceptionSignature(e.getMessage(),
        notFound, ZonedDateTime.now(ZoneId.of("Z")), ErrorCode.ENTITY_NOT_FOUND.getCode(),
  ...
  public ResponseEntity<Object> handleAException(BadRequestException e) {
    ...
    GenericExceptionSignature badRequestException = new GenericExceptionSignature(e.getMessage(),
        badRequest, ZonedDateTime.now(ZoneId.of("Z")), ErrorCode.BAD_REQUEST.getCode(),
  ...
  public ResponseEntity<Object> handleAException(EntityAlreadyExistsException e) {
    ...
    GenericExceptionSignature entityAlreadyExistsException = new GenericExceptionSignature(
        e.getMessage(), badRequest, ZonedDateTime.now(ZoneId.of("Z")),
        ErrorCode.ENTITY_ALREADY_EXISTS.getCode(), ErrorCode.ENTITY_ALREADY_EXISTS.getMessage());
